...
public class Teacher extends Employee implements Manageable, CanborrowBook {
  ...
  public Teacher(String firstName, String lastName, int id, String username, java.util.Date registrationDate, String phoneNumber, Gender gender, String email, int passportNumber) {
    super(firstName, lastName, id, username, registrationDate, phoneNumber, gender, email, passportNumber);
  }

  public Teacher(String firstName, String lastName, int id, String username, java.util.Date registrationDate, String phoneNumber, Gender gender, String email, int passportNumber, TeacherType teacherType, ArrayList<Course> course) {
    super(firstName, lastName, id, username, registrationDate, phoneNumber, gender, email, passportNumber);
    this.teacherType = teacherType;
    this.course = course;
  }
  ...
  public int journalMark(Connection conn) {
    ...
    if (inputUser < 0 || inputUser > course.size()) {
      ...
      try{
        PreparedStatement stat = conn.prepareStatement("INSERT INTO marks (course_id, time, date, mark, student_id) VALUES (?, ?, ?, ?, ?);");
        stat.setInt(1, courseId + 1);
        ...
        stat.setDate(3, date);
        stat.setInt(4, inputUser);
        stat.setInt(5, inputUser2);
